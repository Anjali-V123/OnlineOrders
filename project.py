...
fl.close()
f=open("c5.dat","wb")
l1=["1. Maddie's Margherita pizza-Rs 200","2. Farmhouse pizza -Rs 300","3. Veggie paradise pizza- Rs 300","4. Peppy paneer- Rs 450","5. Chicken dominator- Rs 350","6. Bloody mary pizza- Rs 250","7. Choco lava cake- Rs 55","8. Lasagna- Rs 300","9. Garlic Bread- Rs 150"]
pickle.dump(l1,f)
f.close()
fll=open("c6.dat","wb")
pickle.dump("*",fll)
...
def freq():
    ...
    if ss=="*":
        ...
        MyLabel26=Label(root3,text="Do you want to use the money in your balance account:")
        MyLabel26.pack()
        ...
        def click7():
            ...
            if choice2=="y":
                ...
                MyLabel5555.grid(row=len(m1)+3,column=0)
                MyLabel48=Label(root70,text="Thank you, please visit again")
                MyLabel48.grid(row=len(m1)+3,column=1)
                root70.mainloop()
            else:
                root70=Tk()
...
def previous():
    ...
    try:
        ...
        if m=="*":
            ...
            c.close()
            MyLabel171=Label(root5,text="\n\n\n\n\n Sorry no coupons are available right now")
            MyLabel171.pack()
            pr=open("c7.dat","wb")
            pickle.dump(l,pr)
            pr.close()
            def click109():
                root5.destroy()
            MyButton173=Button(root5,text="Home Page",command=click109)
            MyButton173.pack()
            ...
            if nowrun==2:
                ...
                def click112():
                    root6.destroy()
                MyButton174=Button(root6,text="Home Page",command=click112)
                MyButton174.pack()
                MyButton778=Button(root6,text="checkout",command=checkout)
                MyButton778.pack()
                root6.mainloop()
            elif nowrun>2:
                w=open("b.dat","rb")
                ...
                if kl=="*":
                    ...
                    if mn=="*":
                        ...
                        MyLabel7.pack()
                        MyLabel8=Label(root3,text="showing your choices:")
                        MyLabel8.pack()
                        try:
                            z=open("c.dat","rb")
                            qwe=pickle.load(z)
                            ...
                            z.close()
                        MyLabel14=Label(root3,text="enter your choice-1/2:")
                        MyLabel14.pack()
                        ...
                        def click5():
                            ...
                            if ms==1:
                                ...
                                e.close()
                                root25=Tk()
                                root25.geometry(f"{width}x{height}+{0}+{0}")
                                MyLabel10=Label(root25,text="\n\n\n\n\n saving to your balance")
                                MyLabel10.pack()
                                MyButton9999=Button(root25,text="click to look at final details",command=checkout)
                                MyButton9999.pack()
                                root25.mainloop()
                        MyButton111=Button(root3,text="checkout",command=click5)
                        MyButton111.pack()
                        root3.mainloop()
                    else:
                        freq()
                    ...
                    MyLabel17221.pack()
                    MyButton779=Button(root7,text="checkout",command=checkout)
                    MyButton779.pack()
                    root7.mainloop()
    except EOFError:
        pr.close()
...
def previous2():
    ...
    try:
            ...
            if m=="*":
                ...
                MyLabel21=Label(root7,text="\n\n\n\n\n\n Welcome New Customer!",font=font221)
                MyLabel21.pack()
                def click122():
                    root7.destroy()
                MyButton177=Button(root7,text="Home Page",command=click122)
                MyButton177.pack()
                root7.mainloop()
            else:
                root4=Tk()
                root4.geometry(f"{width}x{height}+{0}+{0}")
                MyLabel11=Label(root4,text="\n\n\n\n\n Showing your previous orders:")
                MyLabel11.pack()
                pr2=open("c9.dat","rb")
                oo=pickle.load(pr2)
                for y in oo:
                ...
                def click123():
                    root4.destroy()
                MyButton178=Button(root4,text="Home Page",command=click123)
                MyButton178.pack()
                root4.mainloop()
    except EOFError:
            pr2.close()
...
def final():
    root3=Tk()
    root3.geometry(f"{width}x{height}+{0}+{0}")
    MyLabel50=Label(root3,text="\n\n\n\n\n Do you want to see your previous orders?")
    MyLabel50.pack()
    def click100():
        previous2()
    def click101():
        ...
        MyLabel222=Label(root66,text="\n\n\n\n\n\n\n\n\n\n ok,please visit again")
        MyLabel222.pack()
        def click345():
            root66.destroy()
        MyButton9990009=Button(root66,text="Home Page",command=click345)
    ...
    MyButton991.pack()
    MyLabel11000=Label(root3,text="Please check for available coupons before proceeding to checkout:")
    MyLabel11000.pack()
    def click102():
        previous()
...
def something():
    ...
    def comm():
        ...
        def click172():
            rootcart.destroy()
        MyButton2221=Button(rootcart,text="Home Page",command=click172)
        MyButton2221.pack()
        rootcart.mainloop()
    ...
    if kk=="*":
        ...
        pickle.dump("##",fl)
        fl.close()
        MyLabel1=Label(root1, text="Do you want to start adding to cart- y/n:",font=Font2)
        ...
        def click():
            ...
            if ord=="y":
                ...
                try:
                    ...
                    f.close()
                for i in range(0,1):
                    MyLabel3=Label(root1,text="Enter the number of the desired item : ")
                    ...
                    def click2():
                        ...
                        if choice=="1":
                            ...
                            n=n+1
                            m1.append(n)
                            MyLabel5=Label(root1,text="Do you want to order more- pls enter y/n:")
                            ...
                            def click3():
                                ...
                                if n1=="y":
                                    ...
                                    final()
                            MyButton3=Button(root1,text="Submit",command=click3)
                            ...
                            pickle.dump(l,fll)
                            fll.close()
                            MyLabel6=Label(root1,text="Do you want to order more- pls enter y/n:")
                            ...
                            def click4():
                                ...
                                if n2=="y":
                                    ...
                                    final()
                            MyButton4=Button(root1,text="submit",command=click4)
                            ...
                            def click5():
                                ...
                                if n3=="y":
                                    ...
                                    final()
                            MyButton5=Button(root1,text="submit",command=click5)
                            ...
                            def click6():
                                ...
                                if nmm=="y":
                                    ...
                                    final()
                            MyButton6=Button(root1,text="submit",command=click6)
                            ...
                            def click7():
                                ...
                                if nmm=="y":
                                    ...
                                    final()
                            MyButton7=Button(root1,text="submit",command=click7)
                            ...
                            def click8():
                                ...
                                if nmm=="y":
                                    ...
                                    final()
                            MyButton8=Button(root1,text="submit",command=click8)
                            ...
                            def click9():
                                ...
                                if nmm=="y":
                                    ...
                                    final()
                            MyButton9=Button(root1,text="submit",command=click9)
                            ...
                            def click10():
                                ...
                                if nmm=="y":
                                    ...
                                    final()
                            MyButton10=Button(root1,text="submit",command=click10)
...
BigFont= Font(family="gabriola",size=42,weight="bold",slant="roman",underline=0,overstrike=0)
MyCanvas.create_text(680,360,text="Hello! Welcome to Saltiez Pizzeria.",font=BigFont,fill="white")
OrderButton=Button(root,text="ORDER NOW",padx=20,command=something,fg="#000000")
OrderButton_window=MyCanvas.create_window(620,450,anchor="nw",window=OrderButton)
